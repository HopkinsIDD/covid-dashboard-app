    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="filter-label threshold-label callout callout-row">{`Selected Date: `}<span className={this.props.dateSliderActive ? 'customLink' : 'bold'}>{getReadableDate(this.props.selectedDate)}</span></div>
